      ...
      <div className="container-content relative">
        ...
        >
          ...
          <motion.div variants={reveal} className="max-w-sm">
            <Image src="/brand/logo-white.svg" alt="Travelora" width={180} height={32} className="h-8 w-auto" priority />
          ...
          <motion.div variants={reveal}>
            ...
            <a href="tel:2085550112" className="mt-2 block text-xl font-semibold text-amber-soft transition-opacity hover:opacity-80">
              (208) 555-0112
            </a>
          </motion.div>
        </motion.div>
...
function FooterHeading({ children }: { children: React.ReactNode }) {
  return (
    <div>
      <h4 className="text-base font-semibold text-amber-soft">{children}</h4>
