    ...
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="container-content">
        <div className="grid items-stretch gap-10 lg:grid-cols-2 lg:gap-14">
          {/* Left: Get in touch + mission + image mosaic */}
          <motion.div
          ...
          >
            ...
            <form onSubmit={(e) => e.preventDefault()} className="mt-6 flex flex-1 flex-col">
              ...
              <div className="mt-5 flex flex-1 flex-col">
                ...
                <textarea
                  ...
                  className="mt-2 min-h-[160px] w-full flex-1 resize-none rounded-lg border border-[#e4e4e4] bg-white px-4 py-3 text-[15px] text-[#373737] placeholder:text-[#c8c6c6] outline-none transition-colors focus:border-navy/50"
                />
              </div>
            </form>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4">
              <button
                type="button"
                className="inline-flex items-center gap-2 rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-black shadow-[0_14px_30px_-12px_rgba(254,188,18,0.9)] transition-all hover:-translate-y-0.5 hover:bg-primary-dark"
              >
