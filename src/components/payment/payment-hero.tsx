...
export default function PaymentHero() {
  return (
    <section className="relative -mt-20 w-full">
      <div className="relative h-[340px] w-full overflow-hidden sm:h-[400px] lg:h-[420px]">
        <motion.div
        ...
        >
          <Image
            src="/images/payment/hero-bg.jpg"
            alt="Checkout"
            fill
            priority
            sizes="100vw"
        ...
        <div className="container-content relative flex h-full flex-col items-center justify-center pt-20 text-center">
          <motion.h1
            ...
            className="text-4xl font-semibold text-white drop-shadow-sm sm:text-5xl lg:text-[52px]"
          >
            Checkout
          </motion.h1>
          <motion.span
